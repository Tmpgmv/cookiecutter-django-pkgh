...
TIME_ZONE = 'Europe/Moscow'  # PREP https://en.wikipedia.org/wiki/List_of_tz_database_time_zones
...
APP_NAME = 'ПКГХ'  # PREP Наименование приложения. Используется по необходимости. В частности, в шаблонах {{ APP_NAME }}.
