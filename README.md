...
После завершения работы над проектом выполните форматирование кода.
Так как предстоит автоматизированная правка кода,
с помощью Git обеспечьте наличие нетронутого линтером кода (например,
в отдельной ветке). 
